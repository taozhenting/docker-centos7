...
RUN wget http://cn2.php.net/distributions/php-7.0.30.tar.gz
RUN tar zxvf php-7.0.30.tar.gz
WORKDIR php-7.0.30
RUN ./configure \
--prefix=/opt/php7.0.30 \
--with-curl \
--with-freetype-dir \
--with-gd \
--with-gettext \
